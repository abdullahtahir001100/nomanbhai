...
<nav id="sidebar">
    <div>
        <div class="p-3 text-center border-bottom border-secondary border-opacity-25">
            ...
            <small class="text-white fw-semibold" style="font-size: 0.78rem; letter-spacing: 0.5px;">WHOLESALE & RETAIL ERP</small>
        </div>
        ...
        <ul class="nav nav-pills flex-column mt-3">
            ...
            <li class="nav-item">
                <a href="repairs.php" class="nav-link <?php echo ($activePage === 'repairs') ? 'active' : ''; ?>">
                    <i class="fa-solid fa-screwdriver-wrench me-2 text-warning"></i> Mobile Repairs (Lab)
                </a>
            </li>
            <li class="nav-item">
