        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-header bg-primary text-white">
                    <div>
                        <h5 class="modal-title fw-bold mb-0"><i class="fa-solid fa-user-plus me-2"></i>Register Client & Create Login</h5>
                        <small class="text-white-50">نیا ہول سیل کلائنٹ رجسٹر کریں اور پورٹل لاگ ان بنائیں</small>
                    </div>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <form action="ledgers.php" method="POST">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="p-3 bg-warning bg-opacity-10 border border-warning rounded-3 mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="fw-bold text-dark small"><i class="fa-solid fa-key text-warning me-1"></i> Client Portal Login (پورٹل لاگ ان)</span>
                                <span class="badge bg-warning text-dark">Wholesale Access</span>
                            </div>
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-dark mb-1">Mobile Number (Username) <span class="text-danger">*</span></label>
                                    <input type="text" name="phone" class="form-control form-control-sm font-monospace fw-bold" placeholder="0300-1234567" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-dark mb-1">Password (جو آپ رکھیں) <span class="text-danger">*</span></label>
                                    <input type="text" name="password" class="form-control form-control-sm font-monospace fw-bold" value="1234" required>
                                </div>
                            </div>
                            <small class="text-muted d-block mt-1" style="font-size: 0.72rem;">Client is mobile aur password se wholesale rate portal login karega</small>
                        </div>
                    ...
                    <div class="modal-footer bg-light">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-primary px-4 fw-bold"><i class="fa-solid fa-save me-1"></i> Register Client & Login</button>
                    </div>
                </form>
            </div>
        </div>
