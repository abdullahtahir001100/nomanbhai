                                    ...
                                    <div>
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            ...
                                            <?php elseif ($stock <= $alertQty): ?>
                                                <span class="badge bg-warning text-dark border border-warning shadow-xs"><i class="fa-solid fa-triangle-exclamation me-1"></i>Low: <?php echo $stock; ?></span>
                                            <?php elseif ($stock >= $highStockQty): ?>
                                                <span class="badge bg-primary text-white shadow-xs"><i class="fa-solid fa-boxes-stacked me-1"></i>High: <?php echo $stock; ?></span>
                                            <?php else: ?>
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            <?php if (!empty($p['image']) && file_exists(__DIR__ . '/' . $p['image'])): ?>
                                                <img src="<?php echo htmlspecialchars($p['image']); ?>" alt="img" class="rounded-2 border shadow-xs object-fit-cover" style="width: 44px; height: 44px; min-width: 44px;">
                                            <?php else: ?>
                                                <div class="rounded-2 bg-light border d-inline-flex align-items-center justify-content-center text-muted" style="width: 44px; height: 44px; min-width: 44px;">
                                            ...
                                            <div class="overflow-hidden">
                                                ...
                                                <small class="text-muted d-block"><i class="fa-solid fa-barcode me-1"></i>SKU: <?php echo htmlspecialchars($sku); ?></small>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="modal-body p-3 bg-white" id="thermalReceiptArea">
                    <div class="thermal-receipt text-center" id="thermalReceiptContent">
                        ...
                        <p class="mb-1 text-muted" style="font-size: 10px;">Milad Chowk Main Bazar Miani | Ph: 0304-1612042</p>
